...
if($_SESSION['position'] == 'Loan Officer'){
 ...
 //         if(isset($_GET['id'])){
	...
	// }
         ...
         $search = $_GET['search'];
         $check_record = "SELECT * FROM withdraw where lastname LIKE '$search' || firstname LIKE '$search' || middlename LIKE '$search' || userid LIKE '$search' || id LIKE '$search' || withdrawdate LIKE '$search' || barangay LIKE '$search' || municipality LIKE '$search' || province LIKE '$search' order by id desc";
...
<body>
	...
	<div class="leftdiv1" id="leftdiv1">
		...
		<div class="btn1" id="btn1">
			...
			<a href="withdraw_record.php" style="background-color: #239cdf;">
...
<!-- 			<img id="menuimg" src="asset/icons/4836503.PNG" width="27" height="27"> -->
		...
		<div class="search-add" id="search-add-refreshbtn">
			...
			<form method="GET" action="withdraw_record.php" autocomplete="off">
				<input type="text" name="search" value="<?php echo $_GET['search'];?>" required>
				<button type="submit">Search</button>
			</form>
			</div>
			<div class="" id="refresh-add">
				<a href="withdraw_record.php" id="refresh"><!-- <img id="menuimg" src="asset/icons/574166.PNG" width="23" height="23"> --><label>Refresh List</label></a>
				<form method="GET" action="export_withdraw_record.php" id="export">
			...
			<?php 
				        ...
				        if($conn->connect_error){
							...
							$search = $_GET['search'];
							$members =  "SELECT * FROM withdraw where lastname LIKE '$search' || firstname LIKE '$search' || middlename LIKE '$search' || userid LIKE '$search' || id LIKE '$search' || withdrawdate LIKE '$search' || barangay LIKE '$search' || municipality LIKE '$search' || province LIKE '$search' order by id desc";
							$members_run = mysqli_query($conn, $members);
		...
		<div class="table" id="table1">
			...
			<div class="list">
					...
					<div class="tablename" id="tablename" style="width: 20%;">
						<div class="tablelist">
							<label id="label"><?php echo $row['withdrawdate']; ?></label>
						</div>	
					</div>
					<div class="tablename" id="tablename" style="width: 20%;">
						<div class="tablelist">
					...
					<div class="tablename" id="tablename" style="width: 25%;">
						<div class="tablelist">
							<label id="label">₱ <?php echo $row['withdrawamount']; ?></label>
						</div>	
					</div>	
					...
					<div class="tablename" id="tablename" style="width: 30%;">
						<form>
           					<a  href="withdraw_record_print.php?id=<?php echo $row['id'];?>" target="_blank" name=""><img src="asset/icons/6285148.PNG" width="30" height="20"></a>
		...
		<div class="table" id="table2">
			<?php
			    ...
			    $sql = "SELECT * FROM withdraw order by withdrawdate desc";
		        $result = $conn->query($sql) or die ($conn->error);
		        $row = $result->fetch_assoc();
		        if (isset($_GET["search"])){  
			...
			<div class="list">
					...
					<div class="tablename" id="tablename" style="width: 70%;">
						<div class="tablelist">
							<label id="label1">User ID :</label ><label id="label2"><?php echo $row['lastname']; ?>, <?php echo $row['firstname']; ?> <?php echo $row['middlename']; ?></label>
						</div>
						<div class="tablelist">
						...
						<div class="tablelist">
							<label id="label1">Date :</label ><label id="label2"><?php echo $row['withdrawdate']; ?></label>
						</div>
						<div class="tablelist" style="margin-top: ;">
							<label id="label1">Amount :</label ><label id="label2"><?php echo $row['withdrawamount']; ?></label>
						</div>
					...
					<div class="tablename" id="tablename" style="width: 30%;">
						<form>
           					<a  href="withdraw_record_print.php?id=<?php echo $row['id'];?>" target="_blank" name=""><img src="asset/icons/6285148.PNG" width="40" height="30"></a>
