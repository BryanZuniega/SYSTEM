...
if (isset($_POST["save"])){
		...
		if ($check_types > 0) {
			...
			$sql = "INSERT INTO loantypes (types, description) VALUES ('$types','$description')";
        ...
        $sql = "SELECT * FROM loantypes order by id";
        ...
        if(isset($_GET['id'])){
			...
			$sql = "DELETE FROM loantypes WHERE id = '$id'";
		...
		<div class="addform" id="addform">
			...
			<form  method="POST" action="" autocomplete="off">
				...
				<div class="forminput" style="flex-direction: column;">
					<div class="input">
						<label>Type :</label>
						<textarea type="text" name="types"  onkeyup="lettersonly(this)" required></textarea>
					</div>
					<div class="input">
						<label>Description :</label>
						<textarea type="text" name="description"  onkeyup="lettersonly(this)" required style="height: 100px;"></textarea>
					</div>
