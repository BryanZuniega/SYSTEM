...
<?php
	...
	if($_SESSION['position'] == 'Loan Officer'){
	 ...
	 include_once("connection.php");
        ...
        // $id = $_GET['loanplansid'];
        $id = $_GET['id'];
        $sql = "SELECT * FROM deposit where id = $id order by id desc";
...
<body onload="window.print()">
	...
	<div class="receiptname">
		...
		<div class="personalinfo" style="border-top: 0px;">
			...
			<div class="userinfo">
				<div class="details"  style="width: 100%;">
					<label id="label3">Date :</label><label id="label2"><?php echo $row['depositdate']; ?></label>
				</div>
			...
			<div class="userinfo" style="border-bottom: 0px;">
				<div class="details"  style="width: 100%;">
					<label id="label3">Amount :</label><label id="label2">₱ <?php echo $row['depositamount']; ?></label>
				</div>
